...
import AssignmentList from '../../components/_dashboard/assignment/AssignmentList';
...
export default function Assignments() {
  ...
  const { assignmentEvents } = useSelector((state: RootState) => state.calendar);
