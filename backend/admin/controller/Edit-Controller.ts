...
const approvalController =(req:any,res:any,next:any)=>{
    ...
    const doc = userDetails.findOneAndUpdate({"id":id},{$set:editUser},{useFindAndModify: false ,new:true},function(errors:any,doc:any){
        if (errors) {
